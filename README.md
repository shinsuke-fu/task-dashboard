...
- **プロジェクト管理**：複数プロジェクトを作成し、プロジェクトごとにタスク・メンバーを分けて
  管理できる（詳細は`docs/要件定義書_プロジェクト管理機能.md`）
...
- [`docs/要件定義書.md`](./docs/要件定義書.md) — タスク管理機能本体の要件定義書
- [`docs/要件定義書_プロジェクト管理機能.md`](./docs/要件定義書_プロジェクト管理機能.md) —
  複数プロジェクト管理機能の要件定義書
- [`docs/基本設計書.md`](./docs/基本設計書.md) — アーキテクチャ・画面構成・データモデル・
  ディレクトリ構成の基本設計書
- [`docs/詳細設計書_認証DB編.md`](./docs/詳細設計書_認証DB編.md) — Supabaseのテーブル・RLS・
  関数の詳細設計書
- [`TODO.md`](./TODO.md) — 未着手・保留中のタスク一覧
- [`規約.md`](./規約.md) — このプロジェクトのコーディングルール
- [`学習ノート.md`](./学習ノート.md) — このアプリのコードを教材にした技術解説・開発の経緯記録
